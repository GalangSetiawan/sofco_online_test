...
/* harmony import */ var _component_shoplist_shoplist_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/shoplist/shoplist.component */ "./src/app/component/shoplist/shoplist.component.ts");
/* harmony import */ var _component_detailbook_detailbook_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./component/detailbook/detailbook.component */ "./src/app/component/detailbook/detailbook.component.ts");
...
const routes = [
    ...
    { path: 'shoplist', component: _component_shoplist_shoplist_component__WEBPACK_IMPORTED_MODULE_5__["ShoplistComponent"] },
    { path: 'detail', component: _component_detailbook_detailbook_component__WEBPACK_IMPORTED_MODULE_6__["DetailbookComponent"] }
];
...
/* harmony import */ var _component_catalog_catalog_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./component/catalog/catalog.component */ "./src/app/component/catalog/catalog.component.ts");
/* harmony import */ var _component_shoplist_shoplist_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./component/shoplist/shoplist.component */ "./src/app/component/shoplist/shoplist.component.ts");
...
/* harmony import */ var _component_detailbook_detailbook_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./component/detailbook/detailbook.component */ "./src/app/component/detailbook/detailbook.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _component_catalog_catalog_component__WEBPACK_IMPORTED_MODULE_7__["CatalogComponent"],
            _component_shoplist_shoplist_component__WEBPACK_IMPORTED_MODULE_8__["ShoplistComponent"],
            _component_header_header_component__WEBPACK_IMPORTED_MODULE_9__["HeaderComponent"],
            _component_detailbook_detailbook_component__WEBPACK_IMPORTED_MODULE_10__["DetailbookComponent"],
        ],
        imports: [
...
let CatalogComponent = class CatalogComponent {
    ...
    nextPage() {
        if (this.currentPage == this.arrPagination.length)
            this.currentPage = this.arrPagination.length;
        else
            this.currentPage += 1;
...
CatalogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./catalog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/component/catalog/catalog.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./catalog.component.css */ "./src/app/component/catalog/catalog.component.css")).default]
    })
], CatalogComponent);
...
let DetailbookComponent = class DetailbookComponent {
    constructor(activateRoute, bookSvc) {
...
DetailbookComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./detailbook.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/component/detailbook/detailbook.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./detailbook.component.css */ "./src/app/component/detailbook/detailbook.component.css")).default]
    })
], DetailbookComponent);
...
let HeaderComponent = class HeaderComponent {
    ...
    ngOnInit() {
        ...
        const source = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(1000);
...
let ShoplistComponent = class ShoplistComponent {
    constructor(bookSvc, router) {
        this.bookSvc = bookSvc;
        this.router = router;
        this.title = "shoplist";
    ...
    hapusBuku(data) {
        sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (willDelete.value) {
                ...
                var tmpData = data;
                this.dataCart = lodash__WEBPACK_IMPORTED_MODULE_4__["remove"](this.dataCart, function (n) {
    ...
    editQty(buku, method) {
        ...
        for (var i in this.masterBook) {
            if (this.masterBook[i].id == buku.id) {
                if (method == 'tambah') {
                    if (this.masterBook[i].stock > 0)
                        this.masterBook[i].stock -= 1;
                }
                else if (method == 'kurang') {
                    if (this.masterBook[i].stock < 10)
                        this.masterBook[i].stock += 1;
                }
            }
        }
...
ShoplistComponent.ctorParameters = () => [
    { type: _service_bookstore_service__WEBPACK_IMPORTED_MODULE_2__["BookstoreService"] },
...
ShoplistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./shoplist.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/component/shoplist/shoplist.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./shoplist.component.css */ "./src/app/component/shoplist/shoplist.component.css")).default]
    })
], ShoplistComponent);
...
module.exports = __webpack_require__(/*! /workspaces/sofco_onlineTest/src/main.ts */"./src/main.ts");
